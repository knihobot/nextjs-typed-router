...
import { GetStaticPropsResult, NextComponentType, NextPageContext as NextPageContextDefault, PreviewData, Redirect } from "next";
import { GetServerSidePropsContext as GetServerSidePropsContextNext, GetStaticPropsContext as GetStaticPropsContextNext } from "next/types";
/**
 * Optional route props
 */
export interface RouteProps<Params extends Record<string, string | (string | undefined)[]> | undefined = Record<string, string | (string | undefined)[]> | undefined, Query extends Record<string, string> | undefined = Record<string, string> | undefined> {
    params: Params;
    query: Query;
}
/**
 ...
 * NextPage
 */
export interface NextPageContext<RouteDefinitions extends Record<string, RouteProps>, RouteName extends keyof RouteDefinitions> extends Omit<NextPageContextDefault, "query"> {
    query: GetRoutePropType<RouteDefinitions, RouteName, "query", undefined>;
}
export type NextPage<RouteDefinitions extends Record<string, RouteProps>, RouteName extends keyof RouteDefinitions, PageProps = Record<string, never>, IPageProps = PageProps> = NextComponentType<NextPageContext<RouteDefinitions, RouteName>, IPageProps, PageProps>;
/**
 * GetStaticProps
 */
export interface GetStaticProps<RouteDefinitions extends Record<string, RouteProps>, RouteName extends keyof RouteDefinitions, Props extends Record<string, string> = Record<string, string>, Data extends PreviewData = PreviewData> {
 ...
 * GetServerSideProps
 */
export interface GetServerSideProps<RouteDefinitions extends Record<string, RouteProps>, RouteName extends keyof RouteDefinitions, Props = unknown, Data extends PreviewData = PreviewData> {
    (context: GetServerSidePropsContext<RouteDefinitions, RouteName, Data>): Promise<GetServerSidePropsResult<Props>>;
}
export type GetServerSidePropsContext<RouteDefinitions extends Record<string, RouteProps>, RouteName extends keyof RouteDefinitions, Data extends PreviewData = PreviewData> = Exclude<GetServerSidePropsContextNext<ParsedUrlQuery, Data>, "params" | "query"> & {
