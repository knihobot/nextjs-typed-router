...
function useRouterTyped(routes) {
    ...
    const pushReplace = (fnName) => (route, as, options, translate) => __awaiter(this, void 0, void 0, function* () {
        const url = (0, resolveExactAddressByRouteName_1.resolveExactAddressByRouteName)(route, routes);
        const urlAs = as
        ...
        yield router[fnName](translatedUrl ? translatedUrl : url, translatedAsUrl ? translatedAsUrl : urlAs, translatedLocale ? Object.assign(Object.assign({}, options), { locale: translatedLocale }) : options);
    });
